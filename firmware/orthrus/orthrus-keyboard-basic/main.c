...
static void gpio_config(void)
{
    ...
    nrf_gpio_cfg_sense_input(S51, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S52, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S53, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S54, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S55, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S61, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S62, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S63, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S64, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S65, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
    nrf_gpio_cfg_sense_input(S71, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
}
...
{
    data_payload[0] = ((keys & 1<<S11) ? 1:0) << 7 | \
                      ((keys & 1<<S21) ? 1:0) << 6 | \
                      ((keys & 1<<S31) ? 1:0) << 5 | \
                      ((keys & 1<<S41) ? 1:0) << 4 | \
                      ((keys & 1<<S51) ? 1:0) << 3 | \
    ...
    data_payload[1] = ((keys & 1<<S32) ? 1:0) << 7 | \
                      ((keys & 1<<S42) ? 1:0) << 6 | \
                      ((keys & 1<<S52) ? 1:0) << 5 | \
                      ((keys & 1<<S62) ? 1:0) << 4 | \
                      ((keys & 1<<S13) ? 1:0) << 3 | \
    ...
    data_payload[2] = ((keys & 1<<S53) ? 1:0) << 7 | \
                      ((keys & 1<<S63) ? 1:0) << 6 | \
                      ((keys & 1<<S14) ? 1:0) << 5 | \
                      ((keys & 1<<S24) ? 1:0) << 4 | \
                      ((keys & 1<<S34) ? 1:0) << 3 | \
    ...
    data_payload[3] = ((keys & 1<<S45) ? 1:0) << 7 | \
                      ((keys & 1<<S55) ? 1:0) << 6 | \
                      ((keys & 1<<S65) ? 1:0) << 5 | \
                      ((keys & 1<<S71) ? 1:0) << 4 | \
                      0 << 0 | \
